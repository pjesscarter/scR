...
for(i in 1:length(pvalues)){
  results[[i]] <- estimate_accuracy(two_year_recid ~ race + sex + age + juv_fel_count + juv_misd_count + priors_count + charge_degree..misd.fel.,mylogit,maxn=nrow(br),dim=7,predictfn = mypred,method = "Class Imbalance", p = pvalues[i],nsample = 100)
}
```
